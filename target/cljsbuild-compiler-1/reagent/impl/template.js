...
return cljs.core._write(writer__26847__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__26240__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__26240__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
} else {
...
var G__32455 = o;
(G__32455[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
while (G__32457__i < G__32457__a.length) {G__32457__a[G__32457__i] = arguments[G__32457__i + 0]; ++G__32457__i;}
  args = new cljs.core.IndexedSeq(G__32457__a,0);
} 
...
var old_32459 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_32459))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_32459)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__26228__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__32462 = jsprops;
(G__32462["defaultValue"] = value);

(G__32462["onChange"] = ((function (G__32462,v,value,on_change){
return (function (p1__32460_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__32460_SHARP_);
});})(G__32462,v,value,on_change))
);
...
var vec__32466 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32466,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32466,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32466,(2),null);
...
var temp__4659__auto__ = (function (){var G__32470 = cljs.core.meta(v);
if((G__32470 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__32470);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = ({"argv": v});
var G__32472_32473 = v;
var G__32472_32474__$1 = (((G__32472_32473 == null))?null:reagent.impl.template.key_from_vec(G__32472_32473));
if((G__32472_32474__$1 == null)){
} else {
(jsprops["key"] = G__32472_32474__$1);
}
...
var G__32478 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input,argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__32478) : reagent.impl.template.as_element.call(null,G__32478));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__32479 = cljs.core.meta(argv);
if((G__32479 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__32479);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__32480 = (((jsprops == null))?({}):jsprops);
(G__32480["key"] = key);
...
var n__27155__auto___32481 = a.length;
var i_32482 = (0);
while(true){
if((i_32482 < n__27155__auto___32481)){
(a[i_32482] = reagent.impl.template.as_element((a[i_32482])));

var G__32483 = (i_32482 + (1));
i_32482 = G__32483;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__27155__auto___32484 = a.length;
var i_32485 = (0);
while(true){
if((i_32485 < n__27155__auto___32484)){
var val_32486 = (a[i_32485]);
if((cljs.core.vector_QMARK_(val_32486)) && ((reagent.impl.template.key_from_vec(val_32486) == null))){
(o["no-key"] = true);
} else {
}

(a[i_32485] = reagent.impl.template.as_element(val_32486));

var G__32487 = (i_32485 + (1));
i_32485 = G__32487;
continue;
} else {
}
...
var G__32489 = (cljs.core.count(argv) - first_child);
switch (G__32489) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__32489){
