...
var c_32364 = (a[i]);
if(cljs.core.truth_((c_32364["cljsIsDirty"]))){
(c_32364["forceUpdate"])();
} else {
}
...
var G__32367 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__32367) : reagent.impl.batching.next_tick.call(null,G__32367));
}
});
...
return cljs.core._write(writer__26847__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__32369 = c;
var G__32369__$1 = (((G__32369 == null))?null:(G__32369["props"]));
if((G__32369__$1 == null)){
return null;
} else {
return (G__32369__$1["argv"]);
}
});
...
var G__32371_32372 = (c["cljsRatom"]);
if((G__32371_32372 == null)){
} else {
reagent.ratom.dispose_BANG_(G__32371_32372);
}
