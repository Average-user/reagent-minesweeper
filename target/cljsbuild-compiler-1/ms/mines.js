...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3((function (l,y){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3((function (e,x){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(ms.mines.get_pos(model,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null)),ms.mines.mine_s)){
return ms.mines.mine_s;
} else {
return e;
}
}),l,cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(l)));
}),board,cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(board)));
});
/**
...
return ms.mines.reveal_all_x(board,model);
} else {
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__32663_SHARP_,ms.mines.mine_s);
});})(b))
,b)))){
...
return (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,p1__32664_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__32664_SHARP_,ms.mines.flag_s));
});})(b))
,b)))){
