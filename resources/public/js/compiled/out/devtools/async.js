...
var o__37350__auto___40458 = (function (){var o__37350__auto__ = (function (){var o__37350__auto__ = Promise;
return goog.object.get(o__37350__auto__,"resolve").call(o__37350__auto__);
})();
return goog.object.get(o__37350__auto__,"then").call(o__37350__auto__,callback);
})();
goog.object.get(o__37350__auto___40458,"catch").call(o__37350__auto___40458,devtools.async.rethrow_outside_promise);
...
var G__40460_40461 = Error;
var target__37369__auto___40462 = G__40460_40461;
if(cljs.core.truth_(target__37369__auto___40462)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__40460_40461)].join('')),cljs.core.str("\n"),cljs.core.str("target__37369__auto__")].join('')));
}

goog.object.set(target__37369__auto___40462,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1498365179240