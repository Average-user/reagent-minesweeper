...
var temp__4657__auto____$1 = goog.object.get(o__37363__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37362__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37362__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__37350__auto__ = f;
return goog.object.get(o__37350__auto__,"toString").call(o__37350__auto__);
}catch (e39775){var _ = e39775;
return "";
}});
...
try{var o__37350__auto___39778 = t;
goog.object.get(o__37350__auto___39778,"cljs$lang$ctorPrWriter").call(o__37350__auto___39778,t,writer);
}catch (e39777){var __39779 = e39777;
}
...
var char_code = (function (){var o__37350__auto__ = (new String(char$));
return goog.object.get(o__37350__auto__,"charCodeAt").call(o__37350__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37350__auto__ = String;
return goog.object.get(o__37350__auto__,"fromCharCode").call(o__37350__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39781 = num_code;
switch (G__39781) {
case (1):
return (185);
...
var o__37350__auto__ = String;
return goog.object.get(o__37350__auto__,"fromCharCode").call(o__37350__auto__,superscript_code);
});
/**
...
}catch (e39787){var e__37375__auto__ = e39787;
return false;
}})())){
...
var vec__39788 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39788,(0),null);
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__37363__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__37363__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37362__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37362__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__27054__auto___39797 = arguments.length;
var i__27055__auto___39798 = (0);
while(true){
if((i__27055__auto___39798 < len__27054__auto___39797)){
args__27061__auto__.push((arguments[i__27055__auto___39798]));

var G__39799 = (i__27055__auto___39798 + (1));
i__27055__auto___39798 = G__39799;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39793){
var vec__39794 = p__39793;
var ns_detector = cljs.core.nth.call(null,vec__39794,(0),null);
...
var G__39800 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39801 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39800;
remaining_tokens = G__39801;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39791){
var G__39792 = cljs.core.first.call(null,seq39791);
var seq39791__$1 = cljs.core.next.call(null,seq39791);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__39792,seq39791__$1);
});
...
var vec__39809 = cljs.core.split_with.call(null,(function (p1__39805_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39805_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39809,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39809,(1),null);
...
var vec__39815 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39815,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39815,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39818 = cljs.core.rest.call(null,remaining_tokens);
var G__39819 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39818;
name_tokens = G__39819;
continue;
} else {
...
args39820.push((arguments[i__27055__auto___39833]));
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args39820.length)].join('')));
...
var vec__39823 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39823,(0),null);
var arity = cljs.core.nth.call(null,vec__39823,(1),null);
var vec__39826 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39826,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39826,(1),null);
var vec__39829 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39829,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39829,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39829,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39829,(3),null);
...
var args39836 = [];
var len__27054__auto___39842 = arguments.length;
var i__27055__auto___39843 = (0);
while(true){
if((i__27055__auto___39843 < len__27054__auto___39842)){
args39836.push((arguments[i__27055__auto___39843]));

var G__39844 = (i__27055__auto___39843 + (1));
i__27055__auto___39843 = G__39844;
continue;
} else {
}
break;
...
var vec__39839 = result;
var munged_ns = cljs.core.nth.call(null,vec__39839,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39839,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39839,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39839,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39839,(4),null);
var arity = cljs.core.nth.call(null,vec__39839,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__39852 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__39852,(0),null);
var args = cljs.core.nth.call(null,vec__39852,(1),null);
var vec__39855 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39855,(0),null);
var name = cljs.core.nth.call(null,vec__39855,(1),null);
...
var G__39858 = (arity + (1));
var G__39859 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39860){
var vec__39864 = p__39860;
var arity = cljs.core.nth.call(null,vec__39864,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39864,(1),null);
...
return cljs.core.get.call(null,arities,p1__39867_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39868_SHARP_);
...
args__27061__auto__.push((arguments[i__27055__auto___39876]));
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39871){
var vec__39872 = p__39871;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39872,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39869){
var G__39870 = cljs.core.first.call(null,seq39869);
var seq39869__$1 = cljs.core.next.call(null,seq39869);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__39870,seq39869__$1);
});
...
var G__39879 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__39879) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39886__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39886__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39886__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39886__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39887 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39887,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39887,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39887,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39887,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39887,(4),null);
var arity = cljs.core.nth.call(null,vec__39887,(5),null);
...
var o__37350__auto__ = f;
return goog.object.get(o__37350__auto__,"getBasis").call(o__37350__auto__);
});
/**
...
}catch (e39892){var e__37375__auto__ = e39892;
...
var G__39893 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__39894 = cljs.core.rest.call(null,path);
obj = G__39893;
path = G__39894;
continue;
} else {
...
return (function (accum,p__39899){
var vec__39900 = p__39899;
var bit = cljs.core.nth.call(null,vec__39900,(0),null);
var protocol = cljs.core.nth.call(null,vec__39900,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39903){
var vec__39907 = p__39903;
var ns = cljs.core.nth.call(null,vec__39907,(0),null);
var name = cljs.core.nth.call(null,vec__39907,(1),null);
var selector = cljs.core.nth.call(null,vec__39907,(2),null);
...
return (function (p__39915){
var vec__39916 = p__39915;
var munged_name = cljs.core.nth.call(null,vec__39916,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39916,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39916,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39910_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__39910_SHARP_));
});})(name,sorted_matches,vec__39916,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1498365176259