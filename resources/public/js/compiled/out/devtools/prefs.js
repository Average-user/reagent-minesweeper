...
var len__27054__auto___37907 = arguments.length;
var i__27055__auto___37908 = (0);
while(true){
if((i__27055__auto___37908 < len__27054__auto___37907)){
args__27061__auto__.push((arguments[i__27055__auto___37908]));

var G__37909 = (i__27055__auto___37908 + (1));
i__27055__auto___37908 = G__37909;
continue;
} else {
}
break;
...
return (p1__37901_SHARP_ === sentinel);
});})(rmaps,sentinel))
;
...
return cljs.core.get.call(null,p1__37902_SHARP_,key,sentinel);
});})(result,todo_keys,key,rmaps,sentinel,sentinel_QMARK_,merged_keys))
,rmaps)));
var G__37910 = cljs.core.assoc.call(null,result,key,val);
var G__37911 = cljs.core.rest.call(null,todo_keys);
result = G__37910;
todo_keys = G__37911;
continue;
}
...
devtools.prefs.simple_merge.cljs$lang$applyTo = (function (seq37903){
var G__37904 = cljs.core.first.call(null,seq37903);
var seq37903__$1 = cljs.core.next.call(null,seq37903);
return devtools.prefs.simple_merge.cljs$core$IFn$_invoke$arity$variadic(G__37904,seq37903__$1);
});
...
var args__27061__auto__ = [];
var len__27054__auto___37915 = arguments.length;
var i__27055__auto___37916 = (0);
while(true){
if((i__27055__auto___37916 < len__27054__auto___37915)){
args__27061__auto__.push((arguments[i__27055__auto___37916]));

var G__37917 = (i__27055__auto___37916 + (1));
i__27055__auto___37916 = G__37917;
continue;
} else {
}
break;
...
devtools.prefs.update_pref_BANG_.cljs$lang$applyTo = (function (seq37912){
var G__37913 = cljs.core.first.call(null,seq37912);
var seq37912__$1 = cljs.core.next.call(null,seq37912);
var G__37914 = cljs.core.first.call(null,seq37912__$1);
var seq37912__$2 = cljs.core.next.call(null,seq37912__$1);
return devtools.prefs.update_pref_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__37913,G__37914,seq37912__$2);
});


//# sourceMappingURL=prefs.js.map?rel=1497141445024