...
args__27061__auto__.push((arguments[i__27055__auto___38067]));
...
return (p1__38060_SHARP_ === sentinel);
});})(rmaps,sentinel))
;
...
return cljs.core.get.call(null,p1__38061_SHARP_,key,sentinel);
});})(result,todo_keys,key,rmaps,sentinel,sentinel_QMARK_,merged_keys))
,rmaps)));
var G__38069 = cljs.core.assoc.call(null,result,key,val);
var G__38070 = cljs.core.rest.call(null,todo_keys);
result = G__38069;
todo_keys = G__38070;
continue;
}
...
devtools.prefs.simple_merge.cljs$lang$applyTo = (function (seq38062){
var G__38063 = cljs.core.first.call(null,seq38062);
var seq38062__$1 = cljs.core.next.call(null,seq38062);
return devtools.prefs.simple_merge.cljs$core$IFn$_invoke$arity$variadic(G__38063,seq38062__$1);
});
...
var args__27061__auto__ = [];
var len__27054__auto___38074 = arguments.length;
var i__27055__auto___38075 = (0);
while(true){
if((i__27055__auto___38075 < len__27054__auto___38074)){
args__27061__auto__.push((arguments[i__27055__auto___38075]));

var G__38076 = (i__27055__auto___38075 + (1));
i__27055__auto___38075 = G__38076;
continue;
} else {
}
break;
...
devtools.prefs.update_pref_BANG_.cljs$lang$applyTo = (function (seq38071){
...
return devtools.prefs.update_pref_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38072,G__38073,seq38071__$2);
});


//# sourceMappingURL=prefs.js.map?rel=1497204735558