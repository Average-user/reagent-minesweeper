...
var G__39921 = devtools.prefs.pref.call(null,v);
v = G__39921;
continue;
} else {
return v;
...
}catch (e39934){var e__37375__auto__ = e39934;
return false;
}})();
...
}catch (e39938){var e__37375__auto__ = e39938;
return false;
}})();
...
}catch (e39940){var e__37375__auto__ = e39940;
return false;
}}
}
});
...
var vec__39945 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39945,(0),null);
var name = cljs.core.nth.call(null,vec__39945,(1),null);
...
return cljs.core.some.call(null,(function (p1__39948_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39948_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1498365176514