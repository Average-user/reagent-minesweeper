...
var G__39691 = devtools.prefs.pref.call(null,v);
v = G__39691;
continue;
} else {
return v;
...
}catch (e39704){var e__37218__auto__ = e39704;
return false;
}})();
...
}catch (e39708){var e__37218__auto__ = e39708;
return false;
}})();
...
}catch (e39710){var e__37218__auto__ = e39710;
return false;
}}
}
});
...
var vec__39715 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39715,(0),null);
var name = cljs.core.nth.call(null,vec__39715,(1),null);
...
return cljs.core.some.call(null,(function (p1__39718_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39718_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1497141452530