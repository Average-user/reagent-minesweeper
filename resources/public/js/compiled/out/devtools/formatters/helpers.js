...
var G__39923 = devtools.prefs.pref.call(null,v);
v = G__39923;
continue;
} else {
return v;
...
}catch (e39936){var e__37377__auto__ = e39936;
return false;
}})();
...
}catch (e39940){var e__37377__auto__ = e39940;
return false;
}})();
...
}catch (e39942){var e__37377__auto__ = e39942;
return false;
}}
}
});
...
var vec__39947 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39947,(0),null);
var name = cljs.core.nth.call(null,vec__39947,(1),null);
...
return cljs.core.some.call(null,(function (p1__39950_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39950_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1497204740482