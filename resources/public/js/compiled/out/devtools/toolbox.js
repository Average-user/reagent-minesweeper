...
var args40198 = [];
var len__27054__auto___40204 = arguments.length;
var i__27055__auto___40205 = (0);
while(true){
if((i__27055__auto___40205 < len__27054__auto___40204)){
args40198.push((arguments[i__27055__auto___40205]));

var G__40206 = (i__27055__auto___40205 + (1));
i__27055__auto___40205 = G__40206;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args40198.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox40201 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox40201 = (function (obj,header,style,tag,meta40202){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox40201.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40203,meta40202__$1){
var self__ = this;
var _40203__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox40201(self__.obj,self__.header,self__.style,self__.tag,meta40202__$1));
});

devtools.toolbox.t_devtools$toolbox40201.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40203){
var self__ = this;
var _40203__$1 = this;
return self__.meta40202;
});

devtools.toolbox.t_devtools$toolbox40201.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox40201.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40201.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox40201.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40201.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta40202","meta40202",-1196613433,null)], null);
});

devtools.toolbox.t_devtools$toolbox40201.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox40201.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox40201";

devtools.toolbox.t_devtools$toolbox40201.cljs$lang$ctorPrWriter = (function (this__26585__auto__,writer__26586__auto__,opt__26587__auto__){
return cljs.core._write.call(null,writer__26586__auto__,"devtools.toolbox/t_devtools$toolbox40201");
});

devtools.toolbox.__GT_t_devtools$toolbox40201 = (function devtools$toolbox$__GT_t_devtools$toolbox40201(obj__$1,header__$1,style__$1,tag__$1,meta40202){
return (new devtools.toolbox.t_devtools$toolbox40201(obj__$1,header__$1,style__$1,tag__$1,meta40202));
});

}

return (new devtools.toolbox.t_devtools$toolbox40201(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1497141455415