...
var c_28393 = (a[i]);
if(cljs.core.truth_((c_28393["cljsIsDirty"]))){
(c_28393["forceUpdate"])();
} else {
}
...
var G__28397 = c;
var G__28397__$1 = (((G__28397 == null))?null:(G__28397["props"]));
if((G__28397__$1 == null)){
return null;
} else {
return (G__28397__$1["argv"]);
}
});
...
var G__28399_28400 = (c["cljsRatom"]);
if((G__28399_28400 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__28399_28400);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1497204720705