...
return (new CustomEvent(event_name,(function (){var obj33195 = {"detail":data};
return obj33195;
})()));
} else {
...
var args33200 = [];
var len__27054__auto___33206 = arguments.length;
var i__27055__auto___33207 = (0);
while(true){
if((i__27055__auto___33207 < len__27054__auto___33206)){
args33200.push((arguments[i__27055__auto___33207]));

var G__33208 = (i__27055__auto___33207 + (1));
i__27055__auto___33207 = G__33208;
continue;
} else {
}
break;
...
var f = (function (){var pred__33203 = cljs.core._EQ_;
var expr__33204 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33203.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33204))){
return ((function (pred__33203,expr__33204){
return (function (p1__33196_SHARP_){
return console.warn(p1__33196_SHARP_);
});
;})(pred__33203,expr__33204))
} else {
if(cljs.core.truth_(pred__33203.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33204))){
return ((function (pred__33203,expr__33204){
return (function (p1__33197_SHARP_){
return console.debug(p1__33197_SHARP_);
});
;})(pred__33203,expr__33204))
} else {
if(cljs.core.truth_(pred__33203.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33204))){
return ((function (pred__33203,expr__33204){
return (function (p1__33198_SHARP_){
return console.error(p1__33198_SHARP_);
});
;})(pred__33203,expr__33204))
} else {
return ((function (pred__33203,expr__33204){
return (function (p1__33199_SHARP_){
return console.log(p1__33199_SHARP_);
});
;})(pred__33203,expr__33204))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33210){
var map__33213 = p__33210;
var map__33213__$1 = ((((!((map__33213 == null)))?((((map__33213.cljs$lang$protocol_mask$partition0$ & (64))) || (map__33213.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33213):map__33213);
var opts = map__33213__$1;
var eval_fn = cljs.core.get.call(null,map__33213__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33215_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__33217,(0),null);
...
var args33220 = [];
var len__27054__auto___33223 = arguments.length;
var i__27055__auto___33224 = (0);
while(true){
if((i__27055__auto___33224 < len__27054__auto___33223)){
args33220.push((arguments[i__27055__auto___33224]));

var G__33225 = (i__27055__auto___33224 + (1));
i__27055__auto___33224 = G__33225;
continue;
} else {
}
break;
...
//# sourceMappingURL=utils.js.map?rel=1497204728357